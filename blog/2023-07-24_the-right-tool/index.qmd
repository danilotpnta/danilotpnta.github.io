...
# categories: [ <i class='bi bi-archive'></i> DevOps, TAGS, Python, Shiny]                    // Bootstrap Icons
# categories: [ "<i class='material-icons'>account_circle</i>",  DevOps, TAGS, Python, Shiny] // Material Icons
categories: [DevOps, TAGS, Python, Shiny]
format:
  html:
    toc: true
---
